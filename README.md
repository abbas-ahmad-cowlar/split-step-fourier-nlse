...
This solver can serve as **validated ground truth** for companion Physics-Informed
Neural Network (PINN) experiments that learn the NLSE. Data generated by this solver can
be checked against the same analytical benchmarks used by the validation suite.

## References

- Agrawal, G. P. *Nonlinear Fiber Optics* (6th ed., 2019) — Chapters 2-5
